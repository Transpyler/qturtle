...
from qturtle import __version__
...
def get_parser():
    ...
    """
    parser = argparse.ArgumentParser('QTurtle')
...
def main(args=None):
    """
    Called with ``python -m qturtle.tests``: run main test suite.
    """
    ...
    import qturtle.tests as test_module
