...
from qturtle.qsci.consolehistory import History
...
class TranspylerConsole(TranspylerConsoleMixin, TranspylerEditor):
    ...
    def __init__(self, transpyler, parent=None, **kwargs):
        ...
        self._runner = TranspylerRunner(transpyler)
    ...
    def keyPressEvent(self, ev):
        ...
        if key in (Return, Enter):
            ...
            # command is complete
                ...
                lineno, lineindex = self.getCursorPosition()
                indent, _ = splitindent(self._current_command[-1])
